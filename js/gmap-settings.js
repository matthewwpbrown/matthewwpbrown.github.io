// ==========  START GOOGLE MAP ========== //
function initialize() {
var myLatLng = new google.maps.LatLng(43.65323,-79.38318);
...
var mapOptions = {
  ...
  var contentString = '<div style="max-width: 300px" id="content">'+
      '<div id="bodyContent">'+
	  '<h4>Jonathan Doe</h4>' +
      '<p style="font-size: 12px">12, Lorem ipsum do, TBA floor, Toronto, Canada. Lorem ipsum dolor sit amet incididunt ut labore et dolore psum dolor magna aliqua.</p>'+
      '</div>'+
      '</div>';
